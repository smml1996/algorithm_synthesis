...
def algorithm1(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	'''fake_algiers-2,fake_geneva-4,fake_montreal-3,fake_valencia-1,fake_bogota-0,fake_bogota-3,fake_essex-2,fake_ourense-2,fake_quito-0,fake_santiago-1,fake_vigo-2,fake_poughkeepsie-0,fake_singapore-2,fake_nairobi-0,fake_casablanca-0,fake_brooklyn-3,fake_manhattan-0,fake_cambridge-3,fake_guadalupe-5,fake_melbourne-5'''
...
def algorithm4(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	'''fake_hanoi-4,fake_cairo-7,fake_cairo-8,fake_mumbai-2,fake_auckland-4,fake_geneva-0,fake_geneva-2,fake_montreal-5,fake_sydney-0,fake_sydney-3,fake_sydney-4,fake_belem-1,fake_lima-0,fake_rome-0,fake_rome-1,fake_rome-2,fake_vigo-1,fake_perth-1,fake_nairobi-2,fake_jakarta-1'''
	instruction_to_ibm(qc, basis_gates, RY1)
	instruction_to_ibm(qc, basis_gates, RY0)
	instruction_to_ibm(qc, basis_gates, H1)
	instruction_to_ibm(qc, basis_gates, RY1)
...
def algorithm5(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	'''fake_hanoi-5,fake_kolkata-0,fake_guadalupe-2,fake_rochester-5'''
	instruction_to_ibm(qc, basis_gates, RY1)
	instruction_to_ibm(qc, basis_gates, RY1)
	instruction_to_ibm(qc, basis_gates, RY0)
	instruction_to_ibm(qc, basis_gates, H1)
...
def algorithm6(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	'''fake_cairo-5,fake_essex-0,fake_essex-3,fake_melbourne-4'''
	instruction_to_ibm(qc, basis_gates, RY1)
	instruction_to_ibm(qc, basis_gates, RY1)
	instruction_to_ibm(qc, basis_gates, RY0)
	instruction_to_ibm(qc, basis_gates, MEAS)
...
def algorithm8(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	'''fake_burlington-0,fake_burlington-3,fake_johannesburg-5,fake_almaden-0,fake_almaden-1,fake_almaden-2,fake_cambridge-0'''
	instruction_to_ibm(qc, basis_gates, RY0)
	instruction_to_ibm(qc, basis_gates, H1)
	instruction_to_ibm(qc, basis_gates, H1)
	instruction_to_ibm(qc, basis_gates, H1)
...
def algorithm9(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	'''fake_burlington-1,fake_burlington-2,fake_essex-1,fake_johannesburg-1,fake_cambridge-1,fake_cambridge-2'''
	instruction_to_ibm(qc, basis_gates, RY0)
	instruction_to_ibm(qc, basis_gates, H1)
	instruction_to_ibm(qc, basis_gates, H1)
	instruction_to_ibm(qc, basis_gates, MEAS)
