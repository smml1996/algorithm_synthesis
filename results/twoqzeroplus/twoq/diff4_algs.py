...
def algorithm3(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	'''fake_algiers-5,fake_cairo-0,fake_cairo-1,fake_cairo-6,fake_cairo-10,fake_kolkata-1,fake_kolkata-2,fake_auckland-3,fake_paris-0,fake_valencia-2,fake_valencia-3,fake_athens-0,fake_belem-0,fake_belem-3,fake_lima-1,fake_manila-2,fake_vigo-3,fake_yorktown-0,fake_johannesburg-3,fake_boeblingen-1,fake_perth-3,fake_lagos-2,fake_oslo-2,fake_jakarta-3,fake_brooklyn-4,fake_manhattan-5'''
	instruction_to_ibm(qc, basis_gates, RY1)
	instruction_to_ibm(qc, basis_gates, RY0)
	instruction_to_ibm(qc, basis_gates, H1)
	instruction_to_ibm(qc, basis_gates, MEAS)
...
def algorithm5(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	'''fake_burlington-1,fake_burlington-2,fake_essex-1,fake_johannesburg-1,fake_almaden-1,fake_singapore-0,fake_cambridge-1,fake_cambridge-2,fake_rochester-3'''
	instruction_to_ibm(qc, basis_gates, RY0)
	instruction_to_ibm(qc, basis_gates, H1)
	instruction_to_ibm(qc, basis_gates, H1)
	instruction_to_ibm(qc, basis_gates, MEAS)
