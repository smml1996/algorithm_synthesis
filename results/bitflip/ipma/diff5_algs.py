...
def algorithm0(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	'''fake_tenerife-0,fake_johannesburg-0,fake_almaden-4,fake_almaden-5,fake_singapore-0,fake_singapore-1,fake_singapore-5,fake_tokyo-6,fake_tokyo-7,fake_perth-0,fake_perth-3,fake_perth-4,fake_hanoi-0,fake_hanoi-1,fake_cairo-7,fake_mumbai-2,fake_mumbai-3,fake_mumbai-4,fake_mumbai-5,fake_mumbai-7,fake_kolkata-0,fake_kolkata-1,fake_kolkata-4,fake_auckland-1,fake_montreal-0,fake_montreal-3,fake_paris-0,fake_paris-4,fake_toronto-4,fake_manhattan-2,fake_cambridge-2,fake_melbourne-3,fake_rochester-0,fake_rochester-1,fake_washington-5'''
...
def algorithm1(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	'''fake_tenerife-1,fake_perth-1,fake_perth-2,fake_oslo-0,fake_oslo-1,fake_oslo-2,fake_oslo-3,fake_oslo-4,fake_cairo-0,fake_kolkata-3,fake_auckland-0,fake_geneva-0,fake_geneva-1,fake_geneva-2,fake_washington-0'''
	instruction_to_ibm(qc, basis_gates, X0)
	instruction_to_ibm(qc, basis_gates, CX12)
	instruction_to_ibm(qc, basis_gates, CX02)
	instruction_to_ibm(qc, basis_gates, P2)
