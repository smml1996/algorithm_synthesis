...
def algorithm3(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	...
	H
	P2
	with qc.if_test((cbits[7], 0)) as else0_:
		P2
		with qc.if_test((cbits[7], 0)) as else1_:
			P2
			with qc.if_test((cbits[7], 0)) as else2_:
				pass
			with else2_:
				P2
				with qc.if_test((cbits[7], 0)) as else3_:
					pass
				with else3_:
					P2
					with qc.if_test((cbits[7], 0)) as else4_:
						pass
					with else4_:
						Z0
		with else1_:
