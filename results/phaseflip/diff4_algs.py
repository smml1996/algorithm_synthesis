...
def algorithm0(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	'''fake_johannesburg-0,fake_almaden-3,fake_singapore-0,fake_singapore-3,fake_tokyo-4,fake_hanoi-0,fake_cairo-0,fake_cairo-2,fake_mumbai-0,fake_mumbai-2,fake_mumbai-3,fake_kolkata-3,fake_auckland-0,fake_montreal-0,fake_montreal-2,fake_paris-1,fake_paris-2,fake_toronto-2,fake_cambridge-2,fake_melbourne-3,fake_rochester-0,fake_rochester-1'''
	H
	P2
...
def algorithm2(qc: QuantumCircuit, basis_gates, cbits: ClassicalRegister):
	'''fake_kolkata-2,fake_geneva-1,fake_washington-0'''
	H
	P2
