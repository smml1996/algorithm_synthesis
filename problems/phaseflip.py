...
if __name__ == "__main__":
    ...
    if arg_backend == "gen_configs":
        ...
        generate_algs_vs_file(PhaseflipExperimentID.IPMA, allowed_hardware, get_hardware_embeddings, get_experiments_actions, with_thermalization=False)
